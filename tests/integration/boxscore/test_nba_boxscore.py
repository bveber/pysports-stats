...
class TestNBABoxscore:
    ...
    def setup_method(self, *args, **kwargs):
        self.results = {
            ...
            "away_points": 98,
            "away_true_shooting_percentage": 0.458,
            "away_effective_field_goal_percentage": 0.419,
            "away_three_point_attempt_rate": 0.384,
            "away_free_throw_attempt_rate": 0.182,
            ...
            "home_points": 119,
            "home_true_shooting_percentage": 0.615,
            "home_effective_field_goal_percentage": 0.604,
            "home_three_point_attempt_rate": 0.451,
            "home_free_throw_attempt_rate": 0.143,
    ...
    def test_nba_boxscore_string_representation(self):
        expected = (
            "Boxscore for Philadelphia 76ers at Milwaukee Bucks "
